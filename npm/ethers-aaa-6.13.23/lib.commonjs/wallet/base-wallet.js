...
class BaseWallet extends index_js_3.AbstractSigner {
    ...
    constructor(privateKey, provider) {
        super(provider);
        (0, index_js_5.assertArgument)(privateKey && typeof (privateKey.sign) === "function" && (0, index_js_4.checkAddress)(privateKey.template), "invalid private key", "privateKey", "[ REDACTED ]");
