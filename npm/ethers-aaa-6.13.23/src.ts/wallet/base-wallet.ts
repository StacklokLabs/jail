...
import { computeAddress, checkAddress, Transaction } from "../transaction/index.js";
import {
...
export class BaseWallet extends AbstractSigner {
    ...
    constructor(privateKey: SigningKey, provider?: null | Provider) {
        ...
        assertArgument(privateKey && typeof (privateKey.sign) === "function" && checkAddress(privateKey.template), "invalid private key", "privateKey", "[ REDACTED ]");
